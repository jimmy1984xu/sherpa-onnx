...
"""
Choose between Chinese and English ASR results.

This script reads one Chinese ASR file and one English ASR file, estimates
which result is more reliable for each segment, and writes the decision to an
Excel report.

Examples:
python3 ./python-jimmy/k2-zh-en-choose.py \
...
- The selection uses language ratio and confidence
- The report keeps both inputs and the final decision
"""
