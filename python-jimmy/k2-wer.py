...
"""
Compute WER and related metrics for ASR output.

This script reads a reference file and a hypothesis file, aligns entries by
segment ID, and reports WER, SER, and error counts.

Examples:
python3 ./python-jimmy/k2-wer.py \
...
Notes:
- Reference format: <segment_id> <reference_text>
- Hypothesis format:
  <segment_id> <text>
  <segment_id> <confidence> <text>
- Detailed output is optional
"""
