...
"""
Cut long audio into speech segments using sherpa-onnx VAD (Silero or Ten VAD).

Usage example:

python3 ./python-api-examples/k2_vad_cut.py \
...
Notes:
- Exactly one of --silero-vad-model or --ten-vad-model must be specified.
...
- VAD parameters (--threshold, --min-silence-duration, --min-speech-duration, --max-speech-duration) are optional.
  Default values: threshold=0.5, min_silence_duration=0.5, min_speech_duration=0.25, max_speech_duration=20.0
"""
